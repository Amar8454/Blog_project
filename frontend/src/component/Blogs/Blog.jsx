...
const Blog = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-100 dark:bg-gray-800 dark:text-white">
      <div className="py-8 text-center space-y-2 dark:text-gray-300">
        <h1 className="text-4xl  font-semibold">All Blogs</h1>
        <p className="text-gray-600 dark:text-gray-200 font-semibold text-xl">
          Explore all articles, stories and insights.
        </p>
      </div>
